...
# MT related
_C.mt = CN()
_C.mt.nopretrain = False
_C.mt.num_features = 256
_C.mt.last_conv_stride = 1
_C.mt.num_classes_seg = 8
_C.mt.dropout = 0.0
_C.mt.global_branch = True
_C.mt.mask_branch = 'part_torso_21'
_C.mt.part_branch = False
_C.mt.mask_dim = 512
_C.mt.part_dim = 128
_C.mt.part_info = 2 
_C.mt.weight = [1,2,8,1,0.125,1,0.1]
_C.mt.normalize_size = True
_C.mt.triplet_margin = 0.5
_C.mt.attr_mask_weight = 0.5
_C.mt.attr_wavp = False
_C.mt.use_attr = True
_C.mt.part_layer = 4
_C.mt.part_abla = False
